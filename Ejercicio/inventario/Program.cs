...
static void salidaDeInventario() {
        ...
        static void ajusteDeentradaInventario() {
            string codigo = "";
            string cantidad = "";
        ...
        static void ajustesalidaDeInventario() {
            string codigo = "";
            string cantidad = "";
        ...
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                Console.WriteLine("4 - Entrada de Inventario");
                Console.WriteLine("5 - Salida de Inventario");
